      ...
      <div className="container pt-80 pb-80">
        <div className="row md-marg">
              ...
              <div className="skills-box row mt-80">
                <div className="col-md-6">
                  <div className="skill-item sm-mb30">
                    <h5 className="sub-title mb-15">UI / UX Design 95%</h5>
                ...
                <div className="col-md-6">
                  <div className="skill-item">
                    <h5 className="sub-title mb-15">Development 90%</h5>
                    <div className="skill-progress">
          ...
          <div className="col-lg-6">
            <div className="imgs">
              <div className="img1">
                <img src="/assets/imgs/intro/intro1.jpg" alt="" />
              </div>
              <div className="img2">
                <img src="/assets/imgs/intro/intro2.jpg" alt="" />
              </div>
              <div className="img3">
                <img src="/assets/imgs/intro/intro3.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
