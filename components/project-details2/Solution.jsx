              ...
              <div className="col-lg-7">
                <div className="text slider-wrapper">
                  <p className="fz-18">
                    ...
                    text. */}
                   We built Fitness to cut through the clutter. Instead of chasing trends, we focus on what actually drives results — smart workouts, personalized plans, and progress you can feel.
                  </p>
                </div>
              </div>
            </div>
