      ...
      <div className="container">
        <div className="info mb-80 pb-20 bord-thin-bottom">
          <div className="row">
            ...
            <div className="col-md-6 col-lg-3">
              <div className="item mb-30">
                <span className="opacity-8 mb-5">Web :</span>
                <h6>Fitness</h6>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
...
The fitness world is full of noise — one-size-fits-all routines, recycled advice, and programs that don’t understand your goals. It’s easy to feel lost in the scroll, wondering what actually works.                  </h5>
                  <p className="fz-18">
...
Whether you're starting out or leveling up, our app adapts to your journey. Real training, real goals, no gimmicks — just fitness that fits your life.                  </p>
                </div>
              </div>
            </div>
          </div>
